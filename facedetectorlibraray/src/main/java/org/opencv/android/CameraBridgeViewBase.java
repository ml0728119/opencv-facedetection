...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CameraBridgeViewBase(Context context, AttributeSet attrs) {
        ...
        DebugLog.d(TAG, "Attr count: " + count);
        ...
        public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
            ...
            switch (mPreviewFormat) {
                ...
                case GRAY:
                    ...
                    break;
                default:
                    DebugLog.e(TAG, "Invalid frame format! Only RGBA and Gray Scale are supported!");
            }
    ...
    public void surfaceChanged(SurfaceHolder arg0, int arg1, int arg2, int arg3) {
        DebugLog.d(TAG, "call surfaceChanged event");
    ...
    private void checkCurrentState() {
        DebugLog.d(TAG, "call checkCurrentState");
        int targetState;
    ...
    private void processEnterState(int state) {
        DebugLog.d(TAG, "call processEnterState: " + state);
        switch (state) {
            case STARTED:
                onEnterStartedState();
                if (mListener != null) {
    ...
    private void processExitState(int state) {
        DebugLog.d(TAG, "call processExitState: " + state);
        switch (state) {
            case STARTED:
                onExitStartedState();
                break;
    ...
    private void onEnterStartedState() {
        DebugLog.d(TAG, "call onEnterStartedState");
        /* Connect camera */
        if (!connectCamera(getWidth(), getHeight())) {
            AlertDialog ad = new AlertDialog.Builder(getContext()).create();
            ad.setCancelable(false); // This blocks the 'BACK' button
            ad.setMessage("似乎您的设备不支持摄像头(或被锁定)。申请将被关闭。");
    ...
    protected void deliverAndDrawFrame(CvCameraViewFrame frame) {
        ...
        if (modified != null) {
            try {
                ...
                DebugLog.i("TAG", "Mat type: " + modified);
                DebugLog.i("TAG", "Bitmap type: " + mCacheBitmap.getWidth() + "*" + mCacheBitmap.getHeight());
            } catch (Exception e) {
                DebugLog.e(TAG, "Mat type: " + modified);
                DebugLog.e(TAG, "Bitmap type: " + mCacheBitmap.getWidth() + "*" + mCacheBitmap.getHeight());
                DebugLog.e(TAG, "Utils.matToBitmap() throws an exception: " + e.getMessage());
                bmpValid = false;
            }
        }
        ...
        if (bmpValid && mCacheBitmap != null) {
            ...
            if (canvas != null) {
                ...
                if (BuildConfig.DEBUG)
                    DebugLog.i("TAG", "mStretch value: " + mScale);
...
//							canvas.getWidth(), canvas.getHeight());
                    //--------------
//                    Bitmap mBlurBitmap = BlurUtils.blur(getContext(), mCacheBitmap, 25, 1f);
...
//					Rect dst = new Rect(0, 0, canvas.getWidth(), canvas.getHeight());
                    //--------------
//                    Bitmap mBlurBitmap = BlurUtils.blur(getContext(), mCacheBitmap, 4, 0.1f);
                    //--------------
                    canvas.drawBitmap(mCacheBitmap, src, dst, null);
                }
